...
def get_user_uuid(event):
    return get(event, 'requestContext.authorizer.jwt.claims.https://acme\.stackref\.com/sr-user-uuid')
...
def get_organization_uuid(event):
    return get(event, 'requestContext.authorizer.jwt.claims.https://acme\.stackref\.com/sr-organization-uuid')
