...
def init():
    ...
    global aws_scim_api_url
    global aws_scim_api_token
    global sso_instance_arn
    global kickoff_fn_arn
    global tator_sqs_url
    global codescans_role
    global analysis_account_id
    global kickoff_sqs_url
    global kickoff_fn_arn
    global kickoff_scheduler_role_arn

    ssm = boto3.client('ssm')
    parameter = ssm.get_parameter(Name=os.environ.get('SR_AWS_SCIM_API_URL_PARAM'), WithDecryption=False)
    aws_scim_api_url = parameter['Parameter']['Value']
    parameter = ssm.get_parameter(Name=os.environ.get('SR_AWS_SCIM_API_TOKEN_PARAM'), WithDecryption=True)
    aws_scim_api_token = parameter['Parameter']['Value']
    ...
    sso_instance_arn = os.environ.get('SR_SSO_INSTANCE_ARN')
    ...
    kickoff_sqs_url = os.environ.get('SR_KICKOFF_SQS_URL')
    kickoff_fn_arn = os.environ.get('SR_KICKOFF_FN_ARN')
