...
from stackref.process_cloud_account_user import process_cloud_account_user, user_uuid_from_team_member_uuid
...
def process_post_method(event):
    ...
    if 'body' in event:
        ...
        if 'cloud_account_user' not in payload_json:
        ...
        authorization = (
            ...
            'manage' in get_team_member_grants(user_uuid, payload_json['cloud_account_user']['team_uuid']),
            'cloud_account_user' in payload_json and user_uuid_from_team_member_uuid(payload_json['cloud_account_user']['team_member_uuid']) == user_uuid
        )
