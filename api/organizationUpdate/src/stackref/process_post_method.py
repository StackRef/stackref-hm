...
from stackref.update_organization import update_organization
...
def process_post_method(event):
    ...
    if 'body' in event:
        ...
        if (
            ...
            'organization' in payload_json and
            payload_json['organization']['organization_uuid']
        ):
            if 'organization_write' not in grants:
                ...
                return update_organization(payload_json)
            else:
