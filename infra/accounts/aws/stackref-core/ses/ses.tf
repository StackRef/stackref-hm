...
<html>
  ...
  <body lang="en-us" style="background:#030A1E;margin:0;padding:0;width:600px;">
    <div style="background-color:#030A1E!important;width:100%;">
      <img style="background:#030A1E;background-image:linear-gradient(#030A1E,#030A1E);display:block;margin:auto;width:600px;" alt="StackRef - Your Formations Official" src="https://cdn.example.com/logo-long.png" />
