resource "aws_s3_bucket" "stackref-analysis-codescans-us-east-1-cloudtrail" {
  bucket        = "stackref-analysis-codescans-us-east-1-cloudtrail"
  force_destroy = true
}

resource "aws_s3_bucket_policy" "stackref_core_cloudtrail" {
  bucket = aws_s3_bucket.stackref-analysis-codescans-us-east-1-cloudtrail.id
  policy = <<POLICY
{
    "Version": "2012-10-17",
    "Statement": [
        {
            ...
            "Resource": "arn:aws:s3:::stackref-analysis-codescans-us-east-1-cloudtrail"
        },
        {
